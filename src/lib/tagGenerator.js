 ...
 *   generateTags(imageUrl)                 — genera tags con Mistral Vision (NSFW-aware)
 ...
 * ÚNICA fuente de verdad para normalización — no duplicar en otros módulos.
 */
...
- clothing: if clothed (e.g. clothed, partially_clothed, nude, naked)
...
- Lowercase only
- Be thorough and accurate — aim for 50-120 tags
- Do NOT censor or omit NSFW content — tag everything you see
- Format: tag1, tag2, tag3, ...`

/**
 * Genera tags automáticos estilo e621 usando Mistral Vision (NSFW-aware).
 *
